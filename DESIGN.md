...
2. get_reviews() and get_review_details(): 
    ...
    - get_review_details(): this function picks relevant details (headline, byline, summary, date, and link to the image) from the list of reviews, ultimately returning a dictionary containing key-value pairs storing the relevant details.  
